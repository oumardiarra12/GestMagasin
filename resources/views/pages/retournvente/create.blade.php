...
@endsection
@section('title_toolbar', 'Nouvau Retour Vente')
@section('subtitle_toolbar', 'Gestion des Retour Ventes')
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('retourventes.store',$vente->id) }}" method="POST" id="createretourvente">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="text" class="form-control" value="{{$vente->num_vente}}"  id="referencevente_vente" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="date" class="form-control" name="date_retourvente" value="{{date('Y-m-d')}}"  id="retourventedate_vente">
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="productimgname">
                                        <input type="text" value="{{$lignevente->produit->nom_produit}}" class="form-control-plaintext border-0" readonly/>
                                        <input type="hidden" value="{{$lignevente->produit_id}}" name="produit_id[]" />
                                      </td>
                                      <td> <input type="number" name="quantite_ligneretourvente[]" value="{{$lignevente->quantite_lignevente}}" class="form-control quantite_ligneretourvente" /></td>
                                      <td><input type="text" name="prixvente_ligneretourvente[]" value="{{$lignevente->prixvente_lignevente}}"  class="form-control-plaintext border-0 prixvente_ligneretourvente" readonly/></td>
                                      <td><input type="text" name="soustotal_ligneretourvente[]" value="{{$lignevente->soustotal_lignevente}}" class="form-control-plaintext border-0 soustotal_ligneretourvente" readonly/></td>
                                      <td>
                    ...
                    <div class="col-lg-12 float-md-right">
                        <div class="total-order">
                            <ul>
                                <li class="total">
                                    <h4>Grand Total</h4>
                                    <h5><input type="text" name="total_retourvente" value="{{$vente->total_vente}}" id="total_retour_vente"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control description_retourvente" name="description_retourvente"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
