...
<body>
    ...
    <table width="100%" style="font-family: sans-serif;" cellpadding="10">
        <tr>
            <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                ...
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> {{$venteretour->vente->client->nom_client}} {{$venteretour->vente->client->prenom_client}}</font></font><br>
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> {{$venteretour->vente->client->email_client}}</font></font><br>
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> {{$venteretour->vente->client->tel_client}}</font></font><br>
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> {{$venteretour->vente->client->adresse_client}}</font></font><br>
                </td>
                <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                ...
                <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                <font style="vertical-align: inherit;margin-bottom:25px;"><font style="vertical-align: inherit;font-size:18px;color:#7367F0;font-weight:600;line-height: 35px; ">Retour Vente</font></font><br>
                ...
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">{{$venteretour->vente->num_vente}} </font></font><br>
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> {{$venteretour->date_retourvente}}</font></font><br>
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> {{$venteretour->num_retourvente}}</font></font><br>
                </td>
        </tr>
    </table>
    <br>
    ...
    <table class="items" width="100%" style="font-size: 14px; border-collapse: collapse;" cellpadding="8">
        ...
        <tbody>
            ...
            <tr>
                <td>{{$ligneventeretour->produit->nom_produit}}</td>
                <td>{{$ligneventeretour->quantite_ligneretourvente}}</td>
                <td>{{$ligneventeretour->prixvente_ligneretourvente}}</td>
                <td>{{$ligneventeretour->soustotal_ligneretourvente}}</td>
            </tr>
            @endforeach
            ...
            <td>
                ...
                <table width="40%" align="right" style="font-family: sans-serif; font-size: 14px;" >
                    <tr>
                        ...
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">{{$venteretour->total_retourvente}}</td>
                    </tr>
                ...
                <table>
                    ...
                    <tr><td>{{$venteretour->description_retourvente}}</td></tr>
                </table>
            </td>
        </tr>
    </table>
