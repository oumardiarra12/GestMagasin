...
@endsection
@section('title_toolbar', 'Nouvau Achat')
@section('subtitle_toolbar', 'Gestion des Achats')
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('achats.store') }}" method="POST" id="createachat">
                @csrf
                @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-lg-10 col-sm-10 col-10">
                                    <select class="placeholder js-states form-control" name="fournisseur_id"
                                        id="fournisseur_id">
                                        <option selected="true" disabled="disabled">Selectionner Fournisseur</option>
                            ...
                            <div class="row">
                                <div class="col-lg-10 col-sm-10 col-10">
                                    <select class="placeholder js-states form-control" name="status_achat_reception"
                                        ...
                                        <option value="reception partial">Reception Partiel</option>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="date" class="form-control" name="date_achat" value="{{date('Y-m-d')}}" id="date_achat">
                                {{-- <div class="addonset">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control description_achat" name="description_achat"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
