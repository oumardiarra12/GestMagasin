...
@endsection
@section('title_toolbar', 'Nouvau Devis')
@section('subtitle_toolbar', 'Gestion des Devis')
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{route('devis.store')}}" method="POST" id="createdevis">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="date" class="form-control" name="date_devis" value="{{date('Y-m-d')}}" id="date_devis">
                                {{-- <div class="addonset">
                    ...
                    <div class="col-lg-12 float-md-right">
                        <div class="total-order">
                            <ul>
                                <li class="total">
                                    <h4>Grand Total</h4>
                                    <h5><input type="text" name="total_devis" id="total_devis"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control description_devis" name="description_devis"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
    ...
    <script>
        ...
        $("#lims_productcodeSearch").autocomplete({
            ...
            select: function(event, ui) {
                ...
                var newRow = `<tr>` +
                    `<td><input type="text" class="produit_id form-control-plaintext" id="` + rowindex +`" value="` + ui.item.label +`" readonly />
