...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('retourachats.update',$achatretour->id) }}" method="POST" id="editretourachat">
                @method('PUT')
                @csrf
                @if ($errors->any())
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="text" class="form-control" value="{{$achatretour->achat->num_achat}}"  id="referenceachat_achat" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Ref. Retour Achat </label>
                            <div class="input-groupicon">
                                <input type="text" class="form-control" value="{{$achatretour->num_retour_achat}}"  id="referenceretourachat_achat" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="date" class="form-control" value="{{$achatretour->date_retour_achat}}" name="date_retour_achat"   id="retourachatdate_achat">
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="productimgname">
                                        <input type="text" value="{{$ligneachatretour->produit->nom_produit}}" class="form-control-plaintext border-0" readonly/>
                                        <input type="hidden" value="{{$ligneachatretour->produit_id}}" name="produit_id[]" />
                                      </td>
                                      <td> <input type="number" name="quantite_retourligneAchat[]" value="{{$ligneachatretour->quantite_retourligneAchat}}" class="form-control quantite_retourligneAchat" /></td>
                                      <td><input type="text" name="prixachat_retourligneAchat[]" value="{{$ligneachatretour->prixachat_retourligneAchat}}"  class="form-control-plaintext border-0 prixachat_retourligneAchat" readonly/></td>
                                      <td><input type="text" name="soustotal_retourligneAchat[]" value="{{$ligneachatretour->soustotal_retourligneAchat}}" class="form-control-plaintext border-0 soustotal_retourligneAchat" readonly/></td>
                                      <td>
                    ...
                    <div class="col-lg-12 float-md-right">
                        <div class="total-order">
                            <ul>
                                <li class="total">
                                    <h4>Grand Total</h4>
                                    <h5><input type="text" name="total_retour_achat" value="{{$achatretour->total_retour_achat}}" id="total_retour_achat"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control description_retour_achat" name="description_retour_achat">{{$achatretour->description_retour_achat}}</textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
