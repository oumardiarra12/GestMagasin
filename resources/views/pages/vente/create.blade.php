...
@endsection
@section('title_toolbar', 'Nouvau Vente')
@section('subtitle_toolbar', 'Gestion des Ventes')
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('ventes.store') }}" method="POST" id="createvente">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="col-lg-12 float-md-right">
                        <div class="total-order">
                            <ul>
                                <li class="total">
                                    <h4>Grand Total</h4>
                                    <h5><input type="text" name="total_vente" id="total_vente"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control description_vente" name="description_vente"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
...
@section('script')
    ...
    <input type="hidden" name="produit_id[]" id="` + rowindex + `" value="` + ui.item.value + `"  /></td>`
                ...
                newRow += `<td><input type="number" id="` + rowindex +
                    `" class="prixvente_lignevente" name="prixvente_lignevente[]" value="` + ui.item.prix + `"/></td>`
